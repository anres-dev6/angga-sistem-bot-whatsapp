...
export default {
    ...
    run: async (sock, m, args) => {
        ...
        try {
            // Ambil soal dari API
            const res = await fetch("https://api.siputzx.my.id/api/games/tebaktebakan");
            ...
            console.error("Tebak-Tebakan Error:", err);
